...
namespace RentingSystem.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(ApplicationUserFirstNameMaxLength, MinimumLength = ApplicationUserFirstNameMinLength, ErrorMessage = StringLengthError)]
            public string FirstName { get; set; }

            [Required(ErrorMessage = ReqiredFildError)]
            [Display(Name = "Last Name")]
            [StringLength(ApplicationUserLastNameMaxLength, MinimumLength = ApplicationUserLastNameMinLength, ErrorMessage = StringLengthError)]
